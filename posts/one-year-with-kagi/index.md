...
bsky:
  uri: at://did:plc:wm37qzgdjvwztq6loytrtpul/app.bsky.feed.post/3mdixl4eju223
  href: https://bsky.app/profile/eliperkins.com/post/3mdixl4eju223
---
...
My normal behavior when using a search engine was to search for some query like [`miami hurricanes football roster`](https://kagi.com/search?q=miami+hurricanes+football+roster&r=us&sh=OKWyh5_XR6R2L3s5bOyB5g) or [`swiftui adjustedcontentinset scrollview`](https://kagi.com/search?q=swiftui+adjustedcontentinset+scrollview&r=us&sh=cxMfXtnaFrKRjJexywvHhg), and then scan the results for a reputable website that could give me a believable answer. I'd open the first few links in new tabs, scanning each tab for the results I was looking for. Over time, I'd learn which websites to trust for certain types of content: Stack Overflow for programming things, Reddit for advice while I shopping for [Buy It For Life](https://www.reddit.com/r/BuyItForLife/) products, Serious Eats for recipes, Sports Reference for a deep dive on sports statistics. The list goes on.
...
It felt like a breath of fresh air whenever I used it. I felt smarter again. Instead of feeling like I was being force-fed some LLM-generated response, I got to surf the web again. I learned about new websites, and rediscovered old ones. It stuck in a way I didn't expect. I suspect the [macOS](https://help.kagi.com/kagi/getting-started/setting-default/safari-mac.html) and [iOS](https://help.kagi.com/kagi/getting-started/setting-default/safari-iphone-ipad.html) Safari extensions had a lot to do with this.

I tried reskinning it with [Kagi's custom CSS](https://help.kagi.com/kagi/features/custom-css.html) to make it look like Google again. After a few hours using it, something felt off, so I reverted back to the stock CSS. Kagi had replaced Google Search completely. Kagi has a million other features to differentiate them from Google that I've explored, from [Lenses](https://help.kagi.com/kagi/features/lenses.html) and [Personalized Results](https://help.kagi.com/kagi/features/website-info-personalized-results.html#personalized-results) to [Code Search](https://help.kagi.com/kagi/features/code.html) and [Search Shortcuts](https://help.kagi.com/kagi/features/search-shortcuts.html). I barely scratch the surface of what Kagi offers, since **Kagi's base offering is just that much better than the alternative.**
...
Kagi recently introduced a similar feature to AI Overviews called "[Auto Quick Answer](https://help.kagi.com/kagi/ai/quick-answer.html)". I'm thankful Kagi introduced a setting to turn this off. I did so immediately after seeing the first one.
...
AI and ML are incredibly powerful tools. I currently use a lot of LLMs, ML and slew other stochastic tools at my job at [Particle](https://particle.news). I probably sit somewhere between an AI skeptic and an AI optimist, since I have seen first hand what these concepts and tools can do, both good and bad. There are ethically and informationally excellent applications of these tools, but I don't think Google's AI Overviews is either of those.
